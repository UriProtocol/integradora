...
const Home = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-2  gap-6 gap-x-12 w-full h-full items-center p-8 lg:p-16">
      ...
      {/* PRIMERA CARTA */}
      <div className="fondo p-8 2xl:p-14 rounded-md shadow flex -mt-10 2xl:-mt-60">
      ...
      {/* TERCERA CARTA */}
      <div className="fondo col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 p-5 2xl:p-10 rounded-md shadow -mt-16 2xl:-mt-80" style={{ gridColumn: "span 2 / span 1" }}>
